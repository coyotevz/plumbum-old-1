"""
    ...
    SQLAlchemy wrapper based on http://github.com/lucuma/sqlalchemy-wrapper
    code and Flask-SQLAlchemy
...
class Pagination(object):
    ...
    def prev(self, error_out=False):
        assert self.query is not None, 'a query object is required for this ' \
                                       'method to work'
